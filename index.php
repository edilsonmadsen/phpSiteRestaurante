                ...
                <div class="reservation-form small-12 columns no-padding">
                    ...
                    <?php
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            $texto_msg = 'E-mail enviado do sistema de reservas 
                                do site' . '<br><br>' . 
                            'Nome: ' . $nome . '<br>' .
                            'E-mail: ' . $email . '<br>' .
                        ...
                        try {
                            ...
                            // Nome do usuário
                            $mail->Username = 'cursophpmailer265@gmail.com';        
                            // Senha do E-mail         
                            $mail->Password = 'Cursophp@';                           
                            ...
                            // Destinatário
                            $mail->addAddress('cursophpmailer265@gmail.com', 'Restrô Bar');
